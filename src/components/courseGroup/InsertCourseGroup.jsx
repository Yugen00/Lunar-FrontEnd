...
function InsertCourseGroup({setOriginalData, setInsertModalOpen }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await customAxios.post('/courseGroup/insert', formData);
...
export default InsertCourseGroup;
