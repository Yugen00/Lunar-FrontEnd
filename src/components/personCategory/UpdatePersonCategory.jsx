...
function UpdatePersonCategory({ handleEditModal, data, updateHandle, isBeingProcessed }) {
        ...
        <>
            <div className='fixed inset-0 z-20 bg-black bg-opacity-75 flex justify-center items-center'>
                <div className='flex mx-auto w-full justify-center'>
                    <div className='w-full border sm:max-w-xl bg-white border-indigo-400 m-4 p-4 sm:m-10 relative'>
...
export default UpdatePersonCategory;
