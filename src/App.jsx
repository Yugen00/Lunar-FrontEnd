...
const InsertPerson = lazy(() => import('./components/person/InsertPerson'));
const UpdatePerson = lazy(() => import('./components/person/UpdatePerson'));
const SeeAllPerson = lazy(() => import('./components/person/SeeAllPerson'));
const EnableLogin = lazy(() => import('./components/person/EnableLogin'));
        ...
        <AuthProvider>
          ...
          <Routes>
            <Route exact path='/' element={
              ...
              {/* For Person  */}
              <Route path='person/'>
                <Route index element={<GetPerson />} />
                <Route path='insert' element={<InsertPerson />} />
                <Route path='enableLogin/:personId' element={<EnableLogin />} />
                <Route path='update/:id' element={<UpdatePerson />} />
                <Route path='seeDetail/:id' element={<SeeAllPerson />} />
              </Route>
